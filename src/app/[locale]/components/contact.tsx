...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-16 h-screen-h flex flex-col gap-8 relative"
    >
      <svg
        id="visual"
        viewBox="0 0 540 540"
      ...
      >
        ...
        <g transform="translate(432.00148469326234 516.4773360048298)">
          <path
        ...
        <div className="space-y-4 w-1/2">
          ...
          >
            ...
            <div className="">
              ...
              <p className="">{process.env.EMAIL_ADDRESS}</p>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className="">
              ...
              <p className="">{process.env.PHONE_NUMBER}</p>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className="">
              ...
              <p className="">@AbderrahmaneOuldgouail</p>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className="">
              ...
              <p className="">@abderrahmane-ouldgouail</p>
            </div>
          </a>
          <a
